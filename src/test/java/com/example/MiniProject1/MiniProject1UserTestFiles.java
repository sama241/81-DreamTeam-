...
public class MiniProject1UserTestFiles {
    ...
    void setUp() {
        ...
        // ✅ Create a test cart with products
    ...
    void tearDown() {
        ...
        // ✅ Fetch cart by userId and delete it properly
    ...
    // ❌ 2️⃣ Test: Removing a non-existent order
    @Test
    ...
    // 🛑 3️⃣ Test: Removing an order from a non-existent user
    @Test
    ...
    void testAddOrderToUser_NoCart() {
        // ✅ Fetch and delete the cart before adding order
        Cart cart = cartService.getCartByUserId(testUserId);
        if (cart != null) {
